...
|---|---|---|
| Que el núcleo funciona | `npm test` | **354 tests** en menos de un segundo |
...
npm test                  # 354 tests, sin modelo y sin red
...
| | |
|---|---|
| Tests | **354 / 354** verdes, sin modelo y sin red |
