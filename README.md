...
|---|---|---|
| Que el núcleo funciona | `npm test` | **349 tests** en menos de un segundo |
...
npm test                  # 349 tests, sin modelo y sin red
...
| | |
|---|---|
| Tests | **349 / 349** verdes, sin modelo y sin red |
