...
|---|---|---|
| Que el núcleo funciona | `npm test` | **367 tests** en menos de un segundo |
...
npm test                  # 367 tests, sin modelo y sin red
...
| | |
|---|---|
| Tests | **367 / 367** verdes, sin modelo y sin red |
