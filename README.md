...
|---|---|---|
| Que el núcleo funciona | `npm test` | **364 tests** en menos de un segundo |
...
npm test                  # 364 tests, sin modelo y sin red
...
| | |
|---|---|
| Tests | **364 / 364** verdes, sin modelo y sin red |
