...
|---|---|---|
| Que el núcleo funciona | `npm test` | **356 tests** en menos de un segundo |
...
npm test                  # 356 tests, sin modelo y sin red
...
| | |
|---|---|
| Tests | **356 / 356** verdes, sin modelo y sin red |
