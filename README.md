...
|---|---|---|
| Que el núcleo funciona | `npm test` | **361 tests** en menos de un segundo |
...
npm test                  # 361 tests, sin modelo y sin red
...
| | |
|---|---|
| Tests | **361 / 361** verdes, sin modelo y sin red |
